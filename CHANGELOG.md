...
* 👮‍♂️ SUMMARY'den çekilen metni kısıtlama eklendi. [Yunus Emre]
  ...
  `untik` anahatar değeri ile verilen metin bulunduğu satıra kadarki verileri ele alır.

  > Satır dahil değildir

* 📝 Google araması için detaylar artırıldı. [Yunus Emre]

* 🚀 Google arama motoru işlemleri yenilendi. [Yunus Emre]

* 📑 Ek açıklamalar eklendi. [Yunus Emre]

* 🔍 Google arama motoru metodu eklendi. [Yunus Emre]

* ✨ Sıralama algoritması eklendi. [Yunus Emre]
